<template>
  <div
    class="p-3 rounded-lg bg-gradient-to-br from-green-500/30 to-teal-600/30 text-white shadow-lg backdrop-blur-md border border-white/20 dark:border-gray-700/50 transition-all"
  >
